...
<body>
    ...
    <header>
        <div class="header">
            <ul class="header__menu">
                ...
                <li class="header__menu__item" style="background-color: rgb(255, 153, 0);"><a href="mobile.php"><i class="fas fa-mobile-alt"></i> MOBILE</a></li>
    ...
    <section>
        <div class="phanloaidata">
            ...
            <select name="sapxep" id="sapxep" onChange="window.location='mobile.php?sort_by='+this.value">
        ...
        <div class="section__iphone">
            <?php
                ...
                $result = mysqli_query($connect, "SELECT count(id) as total FROM product WHERE loai='mobile' $sapxep");
                ...
                $sql = "SELECT * FROM product WHERE loai='mobile' $sapxep LIMIT $start, $limit";

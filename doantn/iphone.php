...
<body>
    ...
    <header>
        <div class="header">
            <ul class="header__menu">
                ...
                <li class="header__menu__item" style="background-color: rgb(255, 153, 0);"><a href="iphone.php"><i class="fab fa-apple"></i> IPHONE</a></li>
    ...
    <section>
        <div class="phanloaidata">
            ...
            <select name="sapxep" id="sapxep" onChange="window.location='iphone.php?sort_by='+this.value">
        ...
        <div class="section__iphone">
            <?php
                ...
                $result = mysqli_query($connect, "SELECT count(id) as total FROM product WHERE loai='iphone' $sapxep");
                ...
                $sql = "SELECT * FROM product WHERE loai='iphone' $sapxep LIMIT $start, $limit";

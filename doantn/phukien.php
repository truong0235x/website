...
<body>
    ...
    <header>
        <div class="header">
            <ul class="header__menu">
                ...
                <li class="header__menu__item" style="background-color: rgb(255, 153, 0);"><a href="phukien.php"><i class="fas fa-headphones"></i> PHỤ KIỆN</a></li>
    ...
    <section>
        <div class="phanloaidata">
            ...
            <select name="sapxep" id="sapxep" onChange="window.location='phukien.php?sort_by='+this.value">
        ...
        <div class="section__iphone">
            <?php
                ...
                $result = mysqli_query($connect, "SELECT count(id) as total FROM product WHERE loai='daysac' or loai='sacduphong' or loai='tainghe' $sapxep");
                ...
                $sql = "SELECT * FROM product WHERE loai='daysac' or loai='tainghe' or loai='sacduphong' $sapxep LIMIT $start, $limit";
